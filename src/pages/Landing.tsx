...
export const Landing: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Yes! Vaultify connects directly to your own Supabase project. We provide the exact SQL code you need to set up your tables instantly."
    },
    {
          ...
          <div className="p-6 sm:p-8 rounded-2xl glass-panel-premium border border-white/10 relative overflow-hidden">
            ...
            <div className="space-y-6 relative">
              <div className="flex items-center gap-4 p-3 rounded-xl bg-white/[0.02] border border-white/5">
                <div className="w-10 h-10 rounded-lg bg-blue-500/20 flex items-center justify-center text-blue-400 font-bold text-xs">1</div>
                <div>
              ...
              <div className="flex items-center gap-4 p-3 rounded-xl bg-gradient-to-r from-purple-950/40 to-slate-900 border border-purple-500/30">
                <div className="w-10 h-10 rounded-lg bg-purple-500/20 flex items-center justify-center text-purple-400 font-bold text-xs">2</div>
                <div>
              ...
              <div className="flex items-center gap-4 p-3 rounded-xl bg-white/[0.02] border border-white/5">
                <div className="w-10 h-10 rounded-lg bg-emerald-500/20 flex items-center justify-center text-emerald-400 font-bold text-xs">3</div>
                <div>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <span className={`text-gray-400 transition-transform duration-300 ${isOpen ? 'rotate-90 text-blue-400' : ''}`}>▶</span>
                </button>
                {isOpen && (
